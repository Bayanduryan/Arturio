    ...
    <div class="form-container">
        <form method="POST" action="">
            <div class="block">
                ...
                <input type="text" class="form-control" name="name" placeholder="Понтий Пилат" value="<?php print $values['name']; ?>" />
            </div>
            <div class="block">
                <span class="block-title">Email</span>
                <input type="text" class="form-control" name="email" placeholder="pilat@mail.com" value="<?php print $values['email']; ?>" />
            </div>
