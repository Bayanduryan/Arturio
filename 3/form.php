        ...
        <form method="POST" action="">
            ...
            <div class="block">
                ...
                <select class="form-select form-select-lg mb-2" name="select[]" multiple>
                    <option value="devil" selected>Воланд</option>
                    <option value="hypnotist">Фагот</option>
                    <option value="shooter">Азазелло</option>
                    <option value="psycho">Бегемот</option>
